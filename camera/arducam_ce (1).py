...
class Camera:
	...
	BUFFER_MAX_LENGTH = 590 # There seems to be an arbitrary maximum of 590 on this
...
##################### INTERNAL FUNCTIONS - LOW LEVEL #####################
	...
	def capture_images(self):
			...
			# Capture 5 more images without overwriting existing ones
			for i in range(max_existing_number + 1, max_existing_number + 6):
				cam.capture_jpg()
				t1 = ticks_ms()
